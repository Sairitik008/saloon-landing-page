...
export default function Testimonials() {
  ...
  return (
    <section className="bg-brand-800 py-24" id="testimonials" ref={ref}>
      <div className={`container transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-[30px]'}`}>
        <div className="text-center max-w-2xl mx-auto mb-16">
          <h2 className="font-display text-4xl text-white tracking-widest uppercase">Stories of Radiance</h2>
          <div className="w-16 h-[1px] bg-brand-500 mx-auto mt-6 mb-6"></div>
          <p className="text-brand-100/70 font-light text-sm max-w-md mx-auto">Discover how our bespoke rituals have elevated the confidence of our lovely clients.</p>
        </div>
